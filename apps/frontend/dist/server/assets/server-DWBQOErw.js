...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-u2e_Cel_.js");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BByLANb0.js"),
		import("./start-CGy9FnLQ.js"),
		import("./empty-plugin-adapters-CykxgOdX.js")
	]);
	return {
		routerEntry,
		startEntry,
